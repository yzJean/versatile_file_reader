#ifndef LLNMAP_SDMAP_COMPONENTS_HPP_
#define LLNMAP_SDMAP_COMPONENTS_HPP_
#include <iostream>
#include <fstream>
#include <sstream>
#include <vector>
...
struct RoadData {
   ...
   friend std::istream &operator>>(std::istream &is, RoadData &road_data) {
      char comma;
      return is >> road_data.lane_count >> comma >>
             road_data.start_longitude >> comma >> road_data.start_latitude >>
             comma >> road_data.end_longitude >> comma >>
...
#endif // LLNMAP_SDMAP_COMPONENTS_HPP_